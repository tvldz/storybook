...
SD_LOCATION = '~/storybook/OnnxStream/src/build/sd'
SD_MODEL_PATH = '~/storybook/storybook/sd_models/stable-diffusion-xl-turbo-1.0-onnxstream'
SD_PROMPT = 'an illustration in a children\'s book for the following scene: '
SD_STEPS = 3
TEMP_IMAGE_FILE = '~/storybook/storybook/image.png' # for temp image storage
FONT_FILE = '~/storybook/storybook/CormorantGaramond-Regular.ttf'
FONT_SIZE = 21
